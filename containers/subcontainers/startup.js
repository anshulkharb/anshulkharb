    ...
    return (
        <Grid container style={{ minHeight: '60vh' }}>
            ...
            <Grid container item xs={10} md={6} lg={4} alignItems="flex-start" justify="center" direction="column">
                ...
                <Box component="span">Saplingo is a career assessment and planning platform which helps to achieve the potential of the students with the help of psychology and data science.</Box><br />
                ...
                <Box component="span">During my stay at IIT Kharagpur, I worked on several ideas which eventually couldn't take off.<br />
                    ...
                    + Sponsdo (Native advertisment + Influencer platform in 2016-17, Recived Incubation from CII)<br />
